        ...
        <section className="text">
          <article>
            ...
            <p>
              ...
              ногу большим пальцем правой ноги. Играю на гитаре. Пока что Макс
              не может придумать больше лоремипсума для этого текста, но я думаю
              вы переживёте.
              <br />
              <i>
                <b>
                  (сайт ещё находится в разработке, поэтому на нём будет рыба
                  предложенная дизайнером макета)
                </b>
              </i>
            </p>
          </article>
